...
import sqlite3
import plotly.io as pio  # Import plotly.io for rendering the plot in a browser


# Function to load the reduced embeddings from a pickle file
...
# Function to perform UMAP dimensionality reduction with parallel processing
...
def plotly_3d_umap(embeddings, labels, title):
    ...
    pio.show(fig)  # Use plotly.io.show to render the plot in the browser
...
print("Loading Kernel PCA-reduced embeddings... Please wait.")
...
print("Kernel PCA-reduced embeddings have been successfully loaded.")

# Visualizing the data with 3D UMAP before applying clustering
print("Visualizing data using 3D UMAP before clustering... Please wait.")
umap_embeddings, umap_model = apply_umap(
    embeddings, n_components=3, n_neighbors=12, min_dist=0.1
)

# Perform K-Means clustering
n_clusters = 12  # Adjust the number of clusters as required
